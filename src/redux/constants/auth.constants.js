...
export const PAYMENTS_REQUEST = "AUTH.PAYMENTS_REQUEST";
export const PAYMENTS_SUCCESS = "AUTH.PAYMENTS_SUCCESS";
export const PAYMENTS_FAILURE = "AUTH.PAYMENTS_FAILURE";
